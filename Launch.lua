...
function launch:OnInit()
	...
	-- package.cpath = package.cpath .. ";C:/Users/crean/.vscode/extensions/tangzx.emmylua-0.5.13/debugger/emmy/windows/x86/?.dll"
	...
	local errMsg
	errMsg, self.main = PLoadModule("ExportMain", self)
	if errMsg then
